...
public struct Strings {
    ...
    public static let workTime = "work_time"
    public static let person = "person"
    public static let configurableNumberOfPersons = "configurable_number_of_persons"
    public static let adults = "adults"
    public static let children = "children"
    public static let alertErrorTitle = "alert_error_title"
    public static let mondayThroughSunday = "monday_through_sunday"
    public static let contactPhone = "contact_phone"
    public static let groupTicketLimitation = "group_ticket_limitation"
}
