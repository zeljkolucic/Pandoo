...
final class EditPhoneViewController: UIViewController {
    ...
    private func configureLayout() {
        ...
        navigationItem.title = Strings.phone.localized
    ...
    @objc private func didTapDoneButton() {
        do {
            try viewModel.changePhone(text)
            navigationController?.popViewController(animated: true)
        } catch {
            let title = Strings.emptyPhone.localized
...
extension EditPhoneViewController: UITableViewDelegate, UITableViewDataSource {
